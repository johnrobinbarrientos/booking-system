...
@section('subhead')
    <title>New Project | Rowland Contractors | Pump Booking System</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"> Create A Project</h2>
    </div>
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-12 2xl:col-span-12">
            <form action="{{ route('projects.store') }}" method="POST" class="w-full">
                @csrf
                        ...
                        <fieldset class="flex w-full">
                            <div class="w-1/2 mr-4">
                                ...
                                <div class="flex flex-col pt-4">
                                    ...
                                    <input type="text" name="project_order_number" class="form-control"
                                        value="{{ old('project_order_number') }}">
                            ...
                            <div class="w-1/2 pl-4 border-l-2">
                                <div class="flex flex-col pt-4">
                                    ...
                                    <textarea name="project_notes" cols="30" rows="10" class="form-control h-20" value="">{{ old('project_notes') }}</textarea>
                                    @error('project_notes')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
