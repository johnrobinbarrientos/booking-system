...
<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
        <a href="" class="flex mr-auto">
            <img alt="" class="w-15 h-12" src="{{ asset('build/assets/images/rowland-logo.png') }}">
        </a>
    ...
    <div class="scrollable">
        ...
        <ul class="scrollable__content py-2">
            @hasanyrole('super admin')
                @foreach ($super_admin_menu as $menuKey => $menu)
                    @if ($menu == 'devider')
            ...
            @endhasanyrole
            @hasanyrole('admin')
                @foreach ($admin_menu as $menuKey => $menu)
                    @if ($menu == 'devider')
                        <li class="menu__devider my-6"></li>
                    @else
                        <li>
            ...
            @endhasanyrole
            @hasanyrole('user')
                @foreach ($user_menu as $menuKey => $menu)
                    @if ($menu == 'devider')
                        <li class="menu__devider my-6"></li>
                    @else
                        <li>
