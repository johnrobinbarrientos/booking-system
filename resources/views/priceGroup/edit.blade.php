...
@section('subhead')
    <title>Update Price Group | Rowland Contractors | Pump Booking System</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"> Update A Price Group</h2>
    </div>
        ...
        <div class="intro-y col-span-12 2xl:col-span-12">
          <form action="{{route('price-groups.update', $priceGroup->id)}}" method="POST">
                    ...
                    <div class="p-5">
                        <fieldset class="flex w-full">
                            <div class="w-1/2 mr-4">
                                <h2 class="text-xl text-primary">Price Group Details</h2>
                                <div class="flex flex-col pt-4">
                                    <label for=""> Name </label>
                                    <input type="text" name="location_name" value="{{$priceGroup->location_name}}" class="form-control">
                                    @error('name')
                ...
                <div class="flex flex-col md:flex-row gap-2 mt-5">
                    <a href="{{route('price-groups.index')}}"
