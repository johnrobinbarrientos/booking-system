...
@section('subhead')
    <title>New Client | Rowland Contractors | Pump Booking System</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"> Create A Client</h2>
    </div>
                    ...
                    <div class="p-5">
                        <div class="w-full flex">
                            <fieldset class="w-1/2 mr-6">
                                ...
                                <div class="flex flex-col pt-4">
                                    <label for="">
                                        <span class="text-gray-700">Company ABN</span>
                                        <input name="abn" value="{{ old('abn') }}" type="text"
                                            class="form-control">
                                    </label>
                                    @error('abn')
                                        <div class="text-sm text-red-600">{{ $message }}</div>
                                ...
                                <div class="flex flex-col pt-4">
                                    <label for="">
                                        ...
                                        <input name="client_number" value="{{ old('client_number') }}" type="text"
                                            class="form-control">
                                    </label>
                                    @error('client_number')
                                        <div class="text-sm text-red-600">{{ $message }}</div>
                            ...
                            <fieldset class="w-1/2 mt-7">
                                ...
                                <div class="flex flex-col pt-4">
                                    ...
                                    <textarea name="client_notes" value="{{ old('client_notes') }}" cols="15" rows="10" class="form-control h-20"></textarea>
                                    @error('client_notes')
                                        <div class="text-sm text-red-600">{{ $message }}</div>
                                    @enderror
                                </div>

                                <div class="form-check mt-5 pt-4">
                        ...
                        <!-- <div class="w-full pt-4 mr-6">
                            <h2 class="text-xl">Contact Details
                            </h2>
                            <table class="table mt-5">
                                ...
                                <tbody class="text-center">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="contact_phone[]"
                                                placeholder="Contact Phone" onblur="checkPhone(this)">
                                        ...
                                        <td>
                                            <input type="hidden" name="is_primary[0]" value="0">
                                            <input id="checkbox-switch-2" name="is_primary[0]" class="form-check-input"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="is_primary[1]" value="0">
                                            <input id="checkbox-switch-3" name="is_primary[1]" class="form-check-input"
                                                value="1" type="checkbox" onClick="updateCheckBox(this)">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="is_primary[2]" value="0">
                                            <input id="checkbox-switch-4" name="is_primary[2]" class="form-check-input"
                                                value="1" type="checkbox" onClick="updateCheckBox(this)">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="is_primary[3]" value="0">
                                            <input id="checkbox-switch-5" name="is_primary[3]" class="form-check-input"
                                                value="1" type="checkbox" onClick="updateCheckBox(this)">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="is_primary[4]" value="0">
                                            <input id="checkbox-switch-6" name="is_primary[4]" class="form-check-input"
                                                value="1" type="checkbox" onClick="updateCheckBox(this)">
...
@section('script')
    ...
    <script>
        // Get all checkboxes with the class name "form-check-input"
        var checkboxes = Array.from(document.getElementsByClassName("form-check-input"));

        // Looping through all checkboxes and add an event listener to each one
        checkboxes.forEach(function(checkbox) {
            checkbox.addEventListener('click', function() {
                updateCheckBox(this, checkboxes);
            });
        });

        function updateCheckBox(checkbox, checkboxes) {
            // Check if checkboxes is defined before calling forEach
            if (checkboxes) {
        ...
        //phone validation to make sure it is either starts with '04' or '+614'
