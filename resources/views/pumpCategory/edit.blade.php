...
@section('subhead')
    <title>Update Pump Category  | Rowland Contractors | Pump Booking System</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"> Update A Pump Category </h2>
    </div>
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-12 2xl:col-span-12">
          <form action="{{route('pump-categories.update', $pumpCategory->id)}}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <fieldset class="flex w-full">
                            <div class="w-1/2 mr-4">
                                ...
                                <div class="flex flex-col pt-4">
                                    ...
                                    <input type="text" name="category_name" value="{{$pumpCategory->category_name}}" class="form-control">
                                    @error('name')
