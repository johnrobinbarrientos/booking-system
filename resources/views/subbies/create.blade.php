...
@section('subhead')
    <title>New Subbie | Rowland Contractors | Pump Booking System</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"> Create A Subbie</h2>
    </div>
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-12 2xl:col-span-12">
            <form action="{{route('subbies.store')}}" method="POST"  class="w-full">
                @csrf
                ...
                <div class="flex flex-col md:flex-row gap-2 mt-5">
                    ...
                    <button type="submit" id="submitBtn" class="btn py-3 btn-primary w-full md:w-52">Save</button>
                </div>
            </form>
        </div>
    </div>
