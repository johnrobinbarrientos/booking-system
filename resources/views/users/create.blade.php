...
@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"> Create An User</h2>
    </div>
                            ...
                            <div class="w-1/2 mr-4">
                                <div class="flex flex-col pt-4">
                                        ...
                                        <div class="flex-col w-1/2 ">
                                            <input id="role" type="radio" name="role" value="admin" class="form-check-input" checked="checked">
                                            <label for="admin-role" style="padding-right:30px;">Admin</label>
                                            
                                            <input id="role" type="radio" name="role" value="user" class="form-check-input">
