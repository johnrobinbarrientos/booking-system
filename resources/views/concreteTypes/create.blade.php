...
@section('subhead')
    <title>New Job Type | Rowland Contractors | Pump Booking System</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"> Create A New Job Type</h2>
    </div>
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-12 2xl:col-span-12">
            <form action="{{route('concreteTypes.store')}}" method="POST"  class="w-full">
                @csrf
                        ...
                        <fieldset class="flex w-full">
                            <div class="w-1/2 mr-4">
                                ...
                                <div class="flex flex-col pt-4">
                                    ...
                                    <input type="text" name="concrete_type" value="{{old('concrete_type')}}" class="form-control">
                                    @error('concrete_type')
