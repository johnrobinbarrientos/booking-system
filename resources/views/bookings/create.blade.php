...
@section('subhead')
    <title>Create a Booking | Rowland Contractors | Pump Booking System</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"> Create A Booking</h2>
    </div>
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-12 2xl:col-span-12">
            <!-- BEGIN: Uplaod Product -->
            <div class="intro-y box p-5" id="add-booking-div">
                <div class="p-5">
                    <form action="{{ route('bookings.store') }}" method="POST" class="w-full">
                        @csrf
                        <fieldset class="flex w-full pt-4">
                            <fieldset class="w-1/2 mr-6">
                                <div class="w-full pt-4">
                                    <label for="">Customer Order Number</label>
                                    <input type="text" name="customer_order_number" id="customer_order_number"
                                ...
                                <div class="flex pt-4">
                                    <div class="flex flex-col w-full mr-4">
                                        ...
                                        <select value="4" name="client_id" id="client_id" class="form-control w-100">
                                ...
                                <div class="flex pt-4">
                                    ...
                                    <div class="flex flex-col w-1/2">
                                        ...
                                        <input type="date" name="date_booked" value="<?php echo date('Y-m-d'); ?>"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="pt-4 mt-5">
                                    ...
                                    <div class="pt-4" id="client_contact_details">
                                        <div>
                                            <label for="ContactName">Client Contact Names</label>
                                        ...
                                        <div class="pt-4">
                                            ...
                                            <textarea name="client_address" id="client_address" cols="20" rows="5" class="form-control" readonly>
                                        </textarea>
                                        </div>
                                    </div>
                                    <div class="pt-4" id="client_none_contact_details">
                                        <div class="mt-4">
                                        ...
                                        <div class="mt-4">
                                            <label for="client-none-contact-no">Contact Number</label>
                                        ...
                                        <div class="pt-4">
                                            ...
                                            <textarea name="client_none_contact_address" id="client_none_contact_address" cols="20" rows="5" class="form-control">
                                        </textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="pt-4 w-full">
                                    ...
                                    <div class="w-full pt-4">
                                        <label for="JobStatus">Choose Booking Status</label>
                                        <?php
                                        $bookingStatus = ['Confirmed', 'Allocated', 'Shadow Booking', 'Canceled', 'Unallocated','Complete','Jobs To Check'];
                                        ?>
                                        <select name="booking_status" id="booking_status" class=" form-control w-full"
                                            required>
                                            <option disabled>Select Status</option>
                                            <?php foreach ($bookingStatus as $status): ?>
                                            <?php if ($status == 'Unallocated'): ?>
                                ...
                                <div class="w-full pt-4">
                                    ...
                                    <input type="text" name="project_order_number" id="project_order_number"
                                        class="form-control w-full" readonly>
                                </div>
                                ...
                                <div class="pt-4 mt-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="flex flex-col pt-4 w-1/2">
                                            ...
                                            <input type="time" name="concrete_time" class="form-control"
                                                required="required">
                                        </div>
                                    </div>
                                    <div class="flex">
                                        <div class="flex flex-col pt-4 mr-4 w-1/2">
                                            ...
                                            <input type="text" name="metres_to_pump" class="form-control">
                                        </div>
                                        <div class="flex flex-col pt-4 w-1/2">
                                            <label for="">Concrete Mix</label>
                                            <input type="text" name="concrete_mix" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-4 w-full">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <textarea name="job_notes" id="job_notes" cols="30" rows="10" class="form-control w-full h-20" readonly></textarea>
                                    </div>
                                    <div class="pt-4">
                                        <label for="">Booking Notes</label>
                                        <textarea name="booking_notes" id="booking_notes" cols="30" rows="10" class="form-control w-full h-20"></textarea>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset class="border-l-2 border-slate-300 pl-4 w-1/2">
                                ...
                                <fieldset>
                                    ...
                                    <div class="flex w-full">
                                                ...
                                                @if (!empty($concreteSuppliers))
                                                    @foreach ($concreteSuppliers as $concreteSupplier)
                                                        <option value="{{ $concreteSupplier->id }}">
                                                            {{ $concreteSupplier->concrete_supplier }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="flex flex-col w-1/2 ">
                                            ...
                                            <select name="concrete_type_id" class="form-control">
                                                <!-- <option selected disabled>Select Concrete Type</option> -->
                                    ...
                                    <div class="flex w-full">
                                        <div class="flex flex-col w-1/2 pt-4 mr-4">
                                            ...
                                            <select name="price_group_id" id="price_group_id" class="form-control">
                                                <!-- <option value="" selected disabled>Price Group</option> -->
                                        ...
                                        <div class="flex flex-col w-1/2 pt-4 mr-4">
                                            ...
                                            <select name="pump_category_id" id="pump_category_id" class="form-control">
                                                <!-- <option value="" selected>Pump Category</option> -->
                                        ...
                                        <div class="flex flex-col w-1/2 pt-4 mr-4">
                                            <label for="pump_size"> Requested Pump Size</label>
                                    ...
                                    <div class="flex w-full">
                                        <div class="flex flex-col w-full pt-4 mr-4">
                                            ...
                                            <input type="text" name="actual_pump_sent" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex w-full">
                                        <div class="flex flex-col w-1/2 pt-4 mr-4">
                                            ...
                                            <div class="flex">
                                                <div class="pt-4 mr-4">
                                                    <input type="text" name="docket_no" id="docket_no" class="form-control" readonly>
                                                </div>
                                                <div class="pt-4">
                                ...
                                <div class="price-preview" id="price_preview">
                                    <fieldset class="w-full mr-6">
                                        <div class="flex">
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                ...
                                                <input type="time" name="time_onsite" id="time_onsite" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <label for="">Time Offsite</label>
                                                <input type="time" name="time_offsite" id="time_offsite" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="min_hire" id="min_hire" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="min_hire_rate" id="min_hire_rate" class="form-control" readonly>
                                            </div>
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="min_hire_total" id="min_hire_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="extra_time" id="extra_time" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="extra_time_rate" id="extra_time_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="extra_time_total" id="extra_time_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="metres_pumped" id="metres_pumped" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="metres_pumped_rate" id="metres_pumped_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="metres_pumped_total" id="metres_pumped_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="additional_man_per_hr" id="additional_man_per_hr" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="additional_man_per_hr_rate" id="additional_man_per_hr_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="additional_man_per_hr_total" id="additional_man_per_hr_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="overtime_per_hr" id="overtime_per_hr" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="overtime_per_hr_rate" id="overtime_per_hr_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="overtime_per_hr_total" id="overtime_per_hr_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="travel_rate" id="travel_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="travel_total" id="travel_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="washout_bag" id="washout_bag" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="washout_bag_rate" id="washout_bag_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="washout_bag_total" id="washout_bag_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="cement_bag" id="cement_bag" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="cement_bag_rate" id="cement_bag_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="cement_bag_total" id="cement_bag_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="offsite_clean_out" id="offsite_clean_out" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="offsite_clean_out_rate" id="offsite_clean_out_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="offsite_clean_out_total" id="offsite_clean_out_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="pipeline_extension" id="pipeline_extension" class="form-control">
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="pipeline_extension_rate" id="pipeline_extension_rate" class="form-control" readonly>
                                            </div>
                                            <div class="flex flex-col pt-4 mr-4">
                                            ...
                                            <div class="flex flex-col pt-4 mr-4 w-1/2">
                                                <input type="text" name="pipeline_extension_total" id="pipeline_extension_total" class="form-control" readonly>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="flex flex-col pt-4 mr-4 w-1/2">
                                            <input type="text" name="ex_gst" id="ex_gst" class="form-control" readonly>
                                        </div>
                                    </div>
            ...
            <div class="flex justify-end flex-col md:flex-row gap-2 mt-5">
                ...
                <button type="submit" class="btn py-3 btn-primary w-full md:w-52">Save & Add New
                    Booking</button>
            </div>
            </form>
        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('.btn-credit-submit').on('click',function(){
            $('#add-booking-div').css('background-color','#fa7268');
        });
        ...
        function setTotals(){
            $("#min_hire_total").val(0);
            $("#metres_pumped_total").val(0);
            $("#additional_man_per_hr_total").val(0);
            $("#overtime_per_hr_total").val(0);
            $("#extra_time_total").val(0);
            $("#travel_total").val(0);
            $("#washout_bag_total").val(0);
            $("#cement_bag_total").val(0);
            $("#offsite_clean_out_total").val(0);
            $("#pipeline_extension_total").val(0);
        }
        ...
        function getClientDetails(){
            ...
            if($('#client_id').val() == 0){
                jQuery("#client_none_contact_details").show();
                jQuery("#client_contact_details").hide();
                ...
                jQuery("#client_none_contact_details").hide();
                jQuery("#client_contact_details").show();
        ...
        // document.querySelector("input[name='job_date']").min = new Date().toISOString().split("T")[0];
        // document.querySelector("input[name='date_booked']").min = new Date().toISOString().split("T")[0];

        //hide price review element 
        const bookingStatus = document.querySelector('#booking_status');
        const price_preview = document.querySelector('#price_preview');

        // Hide the div element by default if the selected value is 'Unallocated'
        ...
        bookingStatus.addEventListener('change', function() {
            // If the selected value is 'Unallocated', hide the div element, otherwise show it
        ...
        // Hide the address select element initially
        jQuery("#project_address_id").empty();


        //change concrete time value
        document.querySelector('input[name="job_start_time"]').addEventListener('change', function() {
            let [hours, minutes] = this.value.split(':');
            let concreteTime = new Date();
            concreteTime.setHours(hours);
            concreteTime.setMinutes(minutes);
            concreteTime.setMinutes(concreteTime.getMinutes() + 30);
            let newHours = concreteTime.getHours();
            let newMinutes = concreteTime.getMinutes();
            document.querySelector('input[name="concrete_time"]').value =
